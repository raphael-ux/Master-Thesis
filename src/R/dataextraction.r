...
#ES <- readRDS("/Users/raphaelbreaud/Downloads/GAS/results/ES_historical_daily.rds")
#VaR <- readRDS("/Users/raphaelbreaud/Downloads/GAS/results/VaR_historical_daily.rds")
#vola <- readRDS("/Users/raphaelbreaud/Downloads/GAS/results/vola_historical_daily.rds")
...
ES <- readRDS("/Users/raphaelbreaud/Downloads/GAS/results/ES_daily_GARCH.rds")
VaR <- readRDS("/Users/raphaelbreaud/Downloads/GAS/results/VaR_daily_GARCH.rds")
vola <- readRDS("/Users/raphaelbreaud/Downloads/GAS/results/vola_daily_GARCH.rds")
...
write.csv(Sharpe_ratio_ES_df,"/Users/raphaelbreaud/Downloads/GAS/results/Sharpe_ratio_ES_GAS.csv",row.names = FALSE)
write.csv(Sharpe_ratio_VaR_df,"/Users/raphaelbreaud/Downloads/GAS/results/Sharpe_ratio_VaR_GAS.csv",row.names = FALSE)
write.csv(Sharpe_ratio_vola_df,"/Users/raphaelbreaud/Downloads/GAS/results/Sharpe_ratio_vola_GAS.csv",row.names = FALSE)
