...
write.csv(Sharpe_ratio_ES_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/Sharpe_ratio_ES_GAS.csv",row.names = FALSE)
write.csv(Sharpe_ratio_VaR_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/Sharpe_ratio_VaR_GAS.csv",row.names = FALSE)
write.csv(Sharpe_ratio_vola_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/Sharpe_ratio_vola_GAS.csv",row.names = FALSE)
...
write.csv(returns_ES_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/return_ES_GAS.csv",row.names = FALSE)
write.csv(returns_VaR_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/return_VaR_GAS.csv",row.names = FALSE)
write.csv(returns_vola_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/return_vola_GAS.csv",row.names = FALSE)
...
write.csv(Cumulative_returns_ES_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/cumulatives_returns_ES_GAS.csv",row.names = FALSE)
write.csv(Cumulative_returns_VaR_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/cumulatives_returns_VaR_GAS.csv",row.names = FALSE)
write.csv(Cumulative_returns_vola_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/cumulatives_returns_vola_GAS.csv",row.names = FALSE)
...
write.csv(volatility_ES_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/volatility_ES_GAS.csv",row.names = FALSE)
write.csv(volatility_VaR_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/volatility_VaR_GAS.csv",row.names = FALSE)
write.csv(volatility_vola_df,"../results/Portfolios_Backtesting/GARCH_Sorting/Monhtly_Sorting/volatility_vola_GAS.csv",row.names = FALSE)
