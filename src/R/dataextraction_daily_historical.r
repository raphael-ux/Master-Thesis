...
ES <- readRDS("../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/ES_historical_daily.rds")
VaR <- readRDS("../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/VaR_historical_daily.rds")
vola <- readRDS("../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/vola_historical_daily.rds")
...
write.csv(Sharpe_ratio_ES_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/Sharpe_ratio_ES_GAS.csv",row.names = FALSE)
write.csv(Sharpe_ratio_VaR_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/Sharpe_ratio_VaR_GAS.csv",row.names = FALSE)
write.csv(Sharpe_ratio_vola_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/Sharpe_ratio_vola_GAS.csv",row.names = FALSE)
...
write.csv(returns_ES_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/return_ES_GAS.csv",row.names = FALSE)
write.csv(returns_VaR_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/return_VaR_GAS.csv",row.names = FALSE)
write.csv(returns_vola_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/return_vola_GAS.csv",row.names = FALSE)
...
write.csv(Cumulative_returns_ES_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/cumulatives_returns_ES_GAS.csv",row.names = FALSE)
write.csv(Cumulative_returns_VaR_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/cumulatives_returns_VaR_GAS.csv",row.names = FALSE)
write.csv(Cumulative_returns_vola_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/cumulatives_returns_vola_GAS.csv",row.names = FALSE)
...
write.csv(volatility_ES_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/volatility_ES_GAS.csv",row.names = FALSE)
write.csv(volatility_VaR_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/volatility_VaR_GAS.csv",row.names = FALSE)
write.csv(volatility_vola_df,"../results/Portfolios_Backtesting/Historical_Sorting/Daily_Sorting/volatility_vola_GAS.csv",row.names = FALSE)
